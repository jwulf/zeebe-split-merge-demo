...
function createWorkers() {
  const worker = zbc.createWorker(
    ...
    (job, complete) => {
      ...
      console.log('%s" input: %j output: %j', taskName, job.variables, job.customHeaders)
